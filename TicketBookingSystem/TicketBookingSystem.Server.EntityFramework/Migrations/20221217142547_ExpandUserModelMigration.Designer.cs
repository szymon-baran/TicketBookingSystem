...
namespace TicketBookingSystem.Server.EntityFramework.Migrations
{
    ...
    [Migration("20221217142547_ExpandUserModelMigration")]
    partial class ExpandUserModelMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketBookingSystem.Shared.Domain.ApplicationUser", b =>
                {
                    ...
                    b.Property<int>("FavouriteMusicGenre")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TicketBookingSystem.Shared.Domain.Artist", b =>
                {
                    ...
                    b.Property<float>("AverageFanbaseAge")
                        .HasColumnType("real");
                    ...
                    b.Property<int>("PrimaryMusicGenre")
                        .HasColumnType("int");

                    b.Property<int?>("SecondaryMusicGenre")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TicketBookingSystem.Shared.Domain.Event", b =>
                {
                    ...
                    b.Property<int>("AvailableSittingTickets")
                        .HasColumnType("int");

                    b.Property<int>("AvailableStandingTickets")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TicketBookingSystem.Shared.Domain.Place", b =>
                {
                    ...
                    b.Property<int>("MaxSittingCapacity")
                        .HasColumnType("int");

                    b.Property<int>("MaxStandingCapacity")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TicketBookingSystem.Shared.Domain.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TicketBookingSystem.Shared.Domain.Event", b =>
                {
                    b.HasOne("TicketBookingSystem.Shared.Domain.Artist", "Artist")
                        .WithMany("Events")
                        .HasForeignKey("ArtistId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TicketBookingSystem.Shared.Domain.Place", "Place")
                        .WithMany("Events")
